...
export default function ComingSoonItem() {
    return (
        <div className="max-w-[536px] min-w-[300px] bg-[url('/assets/images/home/coming-soon-bg-01.jpg')] bg-cover bg-center p-8 rounded-3xl border-2 border-[#2686ec] overflow-hidden">
