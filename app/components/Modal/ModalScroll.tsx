        ...
        <div className="fixed w-screen h-screen inset-0 overflow-y-auto" style={{ zIndex: 1000 }}>
            <div className="flex items-start justify-center min-h-screen px-4">
                ...
                >
                    ...
                    >
                        <h2 className="text-center text-lg font-bold">{title}
                            <button className="absolute top-0 right-0 mx-2 my-0 px-3 py-1 rounded-xl hover:text-red-500" onClick={onClose}>
                                x
                            </button>
                        </h2>
                    </div>

                    <div className="p-6 overflow-y-auto" style={{ maxHeight: "calc(90vh - 50px)" }}>
                        {children}
                    </div>
                </div>
            </div>
