...
export default function PaymentPage() {
    ...
    return (
        <div className="w-screen h-screen overflow-y-auto">
            ...
            <div className='w-full bg-[#8b1dd0] pb-80'>

                <div className="w-2/3 m-auto flex flex-col items-center justify-center min-h-[30vh] gap-10 info-container px-4">

                    {/* <div className='w-3/4 m-auto bg-transparent flex flex-col items-center justify-center mb-10'>
                    ...
                    {/* <div className="w-40 absolute bottom-1 transform left-[50%] translate-x-[-50%] rotate-x-90 origin-bottom z-10">
                                <Image
                            ...
                            <div className="w-40 absolute bottom-0 transform left-[50%] translate-x-[-50%] rotate-y-90 origin-bottom z-10">
                                <Image
                    ...
                    <div className='flex justify-center items-center gap-4 bg-[#7c0fd1] p-10 rounded-lg shadow-2xl'>
                        <div className='w-32 h-32 rounded-ful flex items-center justify-center'>
                    ...
                    <div className='max-w-[71rem] bg-[#42006a] px-20 py-10 rounded-lg shadow-2xl text-center'>
            ...
            <div className='w-10/12 md:w-8/12 mx-auto bg-white p-6 md:p-8 rounded-3xl shadow-2xl transform translate-y-[-20%]'>
